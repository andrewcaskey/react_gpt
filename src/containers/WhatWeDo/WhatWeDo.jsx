...
const WhatGPT3 = () => (
  <div className="it__whatWeDo section__margin" id="wgpt3">
    <div className="it__whatWeDo-feature">
    ...
    <div className="it__whatWeDo-heading">
      <h1 className="gradient__text">The possibilities are beyond your imagination</h1>
      <p>Explore the Library</p>
    </div>
    <div className="it__whatWeDo-container">
